...
import io.iamkrishna73.notes.security.jwt.AuthEntryPointJwt;
import io.iamkrishna73.notes.security.jwt.AuthTokenFilter;
    ...
    public CommandLineRunner initData(RoleRepository roleRepository,
        ...
        return args -> {
            ...
            if (!userRepository.existsByUserName("admin")) {
                io.iamkrishna73.notes.entity.User admin = new User("admin", "admin@example.com",
